...
namespace _011DB_Tetris
{
    class GameGrid
    {
        ...
        {
            // rows are counted from top to bottom, to move down the desired numRows to the current row (r) number, and assign grid[r,c] val to desired location and empty current location
            for (int c = 0; c < columns; c++)
            {
